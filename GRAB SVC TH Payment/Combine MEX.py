...
writer = pd.ExcelWriter('MEX Combine.xlsx', engine = 'xlsxwriter')
df_combine2.to_excel(writer, index=False, sheet_name= 'Combine MEX')
# Get the xlsxwriter workbook and worksheet objects.
workbook  = writer.book
worksheet = writer.sheets['Combine MEX']
