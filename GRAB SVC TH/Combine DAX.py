...
data_file_folder = "Z:\\MIS\\Fone Wasin\\Python\\GRAB SVC TH\\DAX\\"
...
worksheet.write_dynamic_array_formula('F2:F999', '=SUBSTITUTE(D2:D999,RIGHT(D2:D999,4),"")&""')
worksheet.write_dynamic_array_formula('G2:G999', '=_xlfn.IFNA(_xlfn.XLOOKUP(F2:F999,SQL_MAP!$A:A,SQL_MAP!$A:$A),_xlfn.XLOOKUP(E2:E999,SQL_MAP!$A:$A,SQL_MAP!$A:$A))')
worksheet.write_dynamic_array_formula('H2:H999', '=G2:G999')
worksheet.write_dynamic_array_formula('J2:J999', '=C2:C999*1')
worksheet.write_dynamic_array_formula('K2:K999', '=C2:C999*1')
worksheet.write_dynamic_array_formula('L2:L999', '=_xlfn.DATE(_xlfn.RIGHT(A2:A999,4),_xlfn.MID(A2:A999,4,2),_xlfn.LEFT(A2:A999,2))')
...
src_folder = r"Z:\\MIS\\Fone Wasin\\Python\\GRAB SVC TH\\DAX\\"
dst_folder = r"Z:\\MIS\\Fone Wasin\\Python\\GRAB SVC TH\\DAX\\Uploaded\\"
